...
$query = "SELECT p.id_pengaduan as id_pengaduan, m.nama as nama, p.tgl_pengaduan as tgl_pengaduan, p.isi_laporan as isi_laporan, p.foto as foto, p.status as status FROM pengaduan p JOIN masyarakat m WHERE p.nik = m.nik AND p.status is NULL;";
