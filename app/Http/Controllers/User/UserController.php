...
class UserController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        if (!$username) {
            return redirect()->back()->with(['msg' => 'Username tidak terdaftar']);
        }
        ...
        if (Auth::guard('masyarakat')->attempt(['username' => $request->username, 'password' => $request->password])) {
            ...
            return redirect()->back()->with(['msg' => 'Akun Tidak terdaftar']);
        }
    }
    ...
    public function register(Request $request)
    {
        ...
        if ($username) {
            return redirect()->back()->with(['msg' => 'Username sudah terdaftar']);
        }
    ...
    public function storePengaduan(Request $request)
    {
        if (!Auth::guard('masyarakat')->user()) {
            return redirect()->back()->with(['msg' =>'Login dibutuhkan!'])->withInput();
        }
