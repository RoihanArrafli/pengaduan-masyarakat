        ...
        <div class="container">
            <div class="container-fluid">
                <a href="#" class="navbar-brand">
                    <h4 class="semi-bold mb-0 text-white">
                        PEKAT
                    </h4>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav text-center ml-auto">
                        <li class="nav-item">
                            <a class="nav-link ml-3 text-white" href="{{ route('pekat.logout') }}">Laporan</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('pekat.logout') }}" class="nav-link ml-3 text-white" style="text-decoration: underline;">
                    ...
                    <ul class="navbar-nav text-center ml-auto">
                        <li class="nav-item">
                            <button class="btn text-white btn-primary" type="button" data-toggle="modal" data-target="#loginModal">Masuk</button>
                        </li>
                        <li class="nav-item">
...
<div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2021 raply • All rights reserved</p>
    </div>
</div>
{{-- Modal --}}
